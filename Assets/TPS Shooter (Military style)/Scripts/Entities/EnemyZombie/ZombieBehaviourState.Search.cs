...
namespace TPSShooter
{
  ...
  {
    private class SearchState : ZombieBehaviourState
    {
      ...
      public SearchState(ZombieBehaviour host) : base(host)
      {
      }
      ...
      private bool CanChangeStateToIdle()
      {
        ...
        if (host.IsPlayerNoticedByRaycast() && host.GetDistanceToPlayer() < host.playerDetectionRadius) return false;
